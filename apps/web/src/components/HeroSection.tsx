  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/80 backdrop-blur-sm border border-fire-orange/30 mb-6 animate-fade-in" style={{ animationDelay: '0.1s' }}>
            <Flame className="w-4 h-4 text-fire-orange" />
            <span className="text-sm font-medium text-foreground">Pollos a la brasa desde 1995</span>
          </div>

          {/* Main Title */}
          <h1 className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-6 leading-tight animate-fade-in" style={{
          animationDelay: '0.1s'
        }}>
          ...
          animationDelay: '0.2s'
            ...
            Pollos y carnes cocinados lentamente sobre carbón de leña, 
            con el sazón que solo la tradición puede dar.
          </p>

          {/* CTA Button */}
          <button onClick={scrollToMenu} className="btn-fire px-10 py-4 rounded-lg text-lg font-display font-semibold uppercase tracking-wider animate-fade-in" style={{
          animationDelay: '0.3s'
        }}>
